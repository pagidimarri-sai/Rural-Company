    ...
    <>
        ...
        <div className="relative max-w-[1280px] mx-auto px-4 sm:px-6">
          ...
          >
            {features.map((item, index) => (
              <div
                key={index}
                className="flex-shrink-0 min-w-[280px] sm:min-w-[320px] md:min-w-[384px] h-[200px] rounded-xl overflow-hidden shadow bg-white"
              >
                <FeatureCard {...item} />
              </div>
            ))}
      ...
      <div className="mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="mt-10"><AdBanner1 /></div>
          <div className="mt-10"><CleaningPestControlSection /></div>
          <div className="mt-10"><AdBanner /></div>
          <div className="mt-10"><ApplianceRepair /></div>
          <div className="mt-10"><HomeRepair /></div>
          <div className="mt-10"><MassageForMen /></div>
          <div className="mt-10"><AdBanner /></div>
          <div className="mt-10"><SalonForMenSection /></div>
          <div className="mt-10"><FeaturedProfessionals /></div>
