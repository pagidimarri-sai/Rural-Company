// src/components/SalonForMenSection.tsx

import React from "react";

const salonMenItems = [
  {
    imageUrl: "/src/assets/mens facial.png",
    label: "Men's Facial",
    link: "/salon/men-facial",
  },
  {
    imageUrl: "/src/assets/hair colou.webp",
    label: "Hair Coloring",
    link: "/salon/hair-color",
  },
  {
    imageUrl: "/src/assets/haircut.jpg",
    label: "Haircut",
    link: "/salon/haircut",
  },
  {
    imageUrl: "/src/assets/pedicure and manicure.jpg",
